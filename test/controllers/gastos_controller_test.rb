...
class GastosControllerTest < ActionController::TestCase
  ...
  test "should create gasto" do
    assert_difference('Gasto.count') do
      post :create, gasto: { cantidad: @gasto.cantidad, costo: @gasto.costo, detalle: @gasto.detalle, total: @gasto.total }
    end
  ...
  test "should update gasto" do
    patch :update, id: @gasto, gasto: { cantidad: @gasto.cantidad, costo: @gasto.costo, detalle: @gasto.detalle, total: @gasto.total }
    assert_redirected_to gasto_path(assigns(:gasto))
  end
